...
export const tutorialTooltipContent = [
    ...
    },
    {
        id: "practice_edge",
        title: "Arrow",
        text: "Circles are connected by different arrows. Your goal is to select a path along the arrows to earn points. You earn or lose points depending on the color of the arrow.",
        tip: "Click a node",
    },
    {
