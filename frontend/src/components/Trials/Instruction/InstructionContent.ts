export const InstructionContent = [
    {
        id: "welcome",
        text: "Welcome to the experiment! We will start with one practice round to explain the task. In this example, you will not earn points towards your bonus payment.",
    },
    {
        id: "learning_selection",
        text: "Well done! You now have the opportunity to learn from the solutions submitted by up to two previous players, before you play on your own. At the end of the experiment, you will also submit your own solutions, so that future players can learn from them."
    },
    {
        id: "learning",
