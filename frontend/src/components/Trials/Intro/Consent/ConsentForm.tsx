                ...
                <Grid item xs={12}>
                    ...
                    >
                        ...
                        <Typography component={'span'} align={'justify'}>
                            ...
                            In the “Reward Network” study, we want to investigate how different “generations” of problem
                            solvers will approach a strategic task and potentially improve on their payoff. Most of the
                            players in the study are humans, but in some rare cases, they can also be robots. In the
                            beginning of the task, you might get the option to learn from previous solutions, and your
                            own
                        ...
                        <Typography component={'span'} align={'justify'}>
                            ...
                            This study is a research project of the Max Planck Institute (MPI) for Human Development.
                            The
                            ...
                            stored
                            under an individual code number so that it cannot be linked to you during the analysis. The
                            code
                            number is stored on a separate code list in a secure location, and can only be accessed by a
                            limited number of individuals working on the project. The code list is the only link between
                            your Prolific ID and your study data. After completion of the study, the code list will be
                            ...
                            scientific research. The study data may also be used for new research questions going beyond
                            the
                            purposes of this particular study. Please note that once study data are publicly accessible,
                            its
                        ...
                        <Typography component={'span'} align={'justify'}>
                            ...
                            without
                            giving any reason and without any negative consequences. You may also withdraw your consent
                            to
                        ...
                        <Typography component={'span'} align={'justify'}>
                            ...
                            This document has informed you about participation in the “Reward Network” study. The study
                            will
                            take approximately 18 minutes. You will receive compensation of £2.70 for your participation
                            in
                            the study, plus a bonus (£0.70 on average) that is dependent on your own performance and the
                            performance of participants who learned from your solutions in the task. If you decide to
                            terminate your participation before the end of the study, you will receive no compensation.
                        </Typography>
                        <Typography variant="h6" gutterBottom>
                            I have read and understood the conditions outlined above, and had the opportunity to clarify
                            open questions.
                        </Typography>
                        <Grid item xs={12} textAlign={"center"} p={2}>
                            <Button
                                ...
                                I consent to participate in the study and agree to the collection, storage, and use of
                                my data
                                as described above.
                            </Button>
                        </Grid>
